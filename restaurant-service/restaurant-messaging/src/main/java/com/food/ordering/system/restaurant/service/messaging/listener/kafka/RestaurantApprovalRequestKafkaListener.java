    ...
    public void receive(@Payload List<RestaurantApprovalRequestAvroModel> messages,
        ...
        messages.forEach(restaurantApprovalRequestAvroModel -> {
            try {
                ...
                log.error("No restaurant found for restaurant id: {}, and order id: {}", restaurantApprovalRequestAvroModel.getRestaurantId(), restaurantApprovalRequestAvroModel.getOrderId());
            }
        });
    }
